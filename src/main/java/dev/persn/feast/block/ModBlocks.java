...
public class ModBlocks {
    ...
    public static final Block SPICE_RACK = register("spice_rack", SpiceRackBlock::new, AbstractBlock.Settings.create().strength(2.5F, 2.5F).nonOpaque().sounds(BlockSoundGroup.WOOD));
    ...
    public static final BlockEntityType<SpiceRackEntity> SPICE_RACK_ENTITY = FabricBlockEntityTypeBuilder.create(SpiceRackEntity::new, SPICE_RACK).build(null);
    ...
    public static void initBlockEntities() {
        ...
        Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(Feast.MOD_ID, "spice_rack_entity"), SPICE_RACK_ENTITY);
    }
}
